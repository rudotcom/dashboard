					...
					t.exports = function(t) {
						...
						return e.toString = function() {
							return this.map((function(e) {
								var n = "",
									a = void 0 !== e[5];
								return e[4] && (n += "@supports (".concat(e[4], ") {")), e[2] && (n += "@media ".concat(e[2], " {")), a && (n += "@layer".concat(e[5].length > 0 ? " ".concat(e[5]) : "", " {")), n += t(e), a && (n += "}"), e[2] && (n += "}"), e[4] && (n += "}"), n
							})).join("")
							...
							for (var c = 0; c < t.length; c++) {
								var m = [].concat(t[c]);
								a && o[m[0]] || (void 0 !== i && (void 0 === m[5] || (m[1] = "@layer".concat(m[5].length > 0 ? " ".concat(m[5]) : "", " {").concat(m[1], "}")), m[5] = i), n && (m[2] ? (m[1] = "@media ".concat(m[2], " {").concat(m[1], "}"), m[2] = n) : m[2] = n), s && (m[4] ? (m[1] = "@supports (".concat(m[4], ") {").concat(m[1], "}"), m[4] = s) : m[4] = "".concat(s)), e.push(m))
							}
						}, e
					}
				},
						...
						return {
							update: function(n) {
								! function(t, e, n) {
									...
									s && (a += "@layer".concat(n.layer.length > 0 ? " ".concat(n.layer) : "", " {")), a += n.css, s && (a += "}"), n.media && (a += "}"), n.supports && (a += "}");
									var i = n.sourceMap;
									i && "undefined" != typeof btoa && (a += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(i)))), " */")), e.styleTagTransform(a, t, e.options)
								}(e, t, n)
							},
							remove: function() {
								! function(t) {
		...
		return function() {
			...
			function v(t, e) {
				for (var n = 0; n < e.length; n++) {
					var a = e[n];
					a.enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(t, b(a.key), a)
				}
			}
			...
			f.styleTagTransform = h(), f.setAttributes = c(), f.insert = l().bind(null, "head"), f.domAPI = i(), f.insertStyleElement = u(), e()(p.Z, f), p.Z && p.Z.locals && p.Z.locals;
			var g, _ = ["rtl", "style", "headerType", "contentLayout", "layoutCollapsed", "showDropdownOnHover", "layoutNavbarOptions", "layoutFooterFixed", "themes"],
				S = ["light", "dark", "system"],
				...
				A = function() {
					function t(e) {
						...
						if (function(t, e) {
							...
							if (this.settings = {}, this.settings.cssPath = n, this.settings.themesPath = a, this.settings.cssFilenamePattern = s || "%name%.css", this.settings.displayCustomizer = void 0 === i || i, this.settings.controls = o || _, this.settings.defaultTextDir = "rtl" === l || C, this.settings.defaultHeaderType = r || E, this.settings.defaultMenuCollapsed = void 0 !== m ? m : T, this.settings.defaultContentLayout = void 0 !== c ? c : "compact", this.settings.defaultShowDropdownOnHover = void 0 === u || u, this.settings.defaultNavbarType = void 0 !== d ? d : N, this.settings.defaultFooterFixed = void 0 !== h ? h : L, this.settings.availableDirections = b || t.DIRECTIONS, this.settings.availableStyles = g || t.STYLES, this.settings.availableThemes = z || t.THEMES, this.settings.availableHeaderTypes = O || t.HEADER_TYPES, this.settings.availableContentLayouts = v || t.CONTENT, this.settings.availableLayouts = A || t.LAYOUTS, this.settings.availableNavbarOptions = R || t.NAVBAR_OPTIONS, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== F ? F : w), this.settings.styles = p || S, this.settings.navbarOptions = f || x, this.settings.defaultStyle = y || k, this.settings.lang = P || "en", this.pathResolver = I || function(t) {
									return t
								}, this.settings.styles.length < 2) {
								var q = this.settings.controls.indexOf("style"); - 1 !== q && (this.settings.controls = this.settings.controls.slice(0, q).concat(this.settings.controls.slice(q + 1)))
							}
							this.settings.onSettingsChange = "function" == typeof D ? D : function() {}, this._loadSettings(), this._listeners = [], this._controls = {}, this._initDirection(), this._initStyle(), this._initTheme(), this.setLayoutType(this.settings.headerType, !1), window.Helpers.setCollapsed(this.settings.layoutCollapsed, !1), this.setContentLayout(this.settings.contentLayout, !1), this.setDropdownOnHover(this.settings.showDropdownOnHover, !1), this.setLayoutNavbarOption(this.settings.layoutNavbarOptions, !1), this.setLayoutFooterFixed(this.settings.layoutFooterFixed, !1), this._setup()
						}
					}
					var e, n;
					return e = t, n = [{
						...
						value: function(t) {
							...
							if (this._hasControls("themes")) {
								...
								if (a) {
									...
									this._loadStylesheets((s = {}, i = l, o = document.querySelector(".template-customizer-theme-css"), (i = b(i)) in s ? Object.defineProperty(s, i, {
										value: o,
										enumerable: !0,
										configurable: !0,
										writable: !0
									}) : s[i] = o, s), n || function() {}), e && this.settings.onSettingsChange.call(this, this.settings)
								}
							}
						}
					}, {
						...
						value: function(t) {
							...
							if (this._hasControls("headerType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
								...
								"fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType ? a && n && (window.Helpers.menuPsScroll.destroy(), n = new a(document.querySelector(".menu-inner"), {
									suppressScrollX: !0,
									wheelPropagation: !1
						...
						value: function() {
							if (!this._ssr) {
								...
								this._controls.showDropdownOnHover && (e ? (this._controls.showDropdownOnHover.setAttribute("disabled", "disabled"), this._controls.showDropdownOnHover.classList.add("disabled")) : (this._controls.showDropdownOnHover.removeAttribute("disabled"), this._controls.showDropdownOnHover.classList.remove("disabled"))), this._controls.layoutNavbarOptions && (t ? (this._controls.layoutNavbarOptions.removeAttribute("disabled"), this._controls.layoutNavbarOptionsW.classList.remove("disabled")) : (this._controls.layoutNavbarOptions.setAttribute("disabled", "disabled"), this._controls.layoutNavbarOptionsW.classList.add("disabled")), n && t && "fixed" === this.settings.headerType && (this._controls.layoutNavbarOptions.setAttribute("disabled", "disabled"), this._controls.layoutNavbarOptionsW.classList.add("disabled"))), this._controls.layoutFooterFixed && (a ? (this._controls.layoutFooterFixed.removeAttribute("disabled"), this._controls.layoutFooterFixedW.classList.remove("disabled")) : (this._controls.layoutFooterFixed.setAttribute("disabled", "disabled"), this._controls.layoutFooterFixedW.classList.add("disabled"))), this._controls.headerType && (e || n ? this._controls.headerType.removeAttribute("disabled") : this._controls.headerType.setAttribute("disabled", "disabled"))
							}
						}
					}, {
						key: "clearLocalStorage",
						value: function() {
							this._ssr || (this._setSetting("Theme", ""), this._setSetting("Style", ""), this._setSetting("LayoutCollapsed", ""), this._setSetting("FixedNavbarOption", ""), this._setSetting("LayoutType", ""), this._setSetting("contentLayout", ""), this._setSetting("Rtl", ""), this._showResetBtnNotification(!1))
						}
					}, {
						key: "destroy",
						value: function() {
						...
						key: "_loadSettings",
						value: function() {
							var t, e, n = this._getSetting("Rtl"),
							...
							"" !== n || "" !== a || "" !== s || "" !== i || "" !== o || "" !== r || "" !== m ? this._showResetBtnNotification(!0) : this._showResetBtnNotification(!1), t = "" !== m && -1 !== ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].indexOf(m) ? m : this.settings.defaultHeaderType, this.settings.headerType = t, this.settings.rtl = "" !== n ? "true" === n : this.settings.defaultTextDir, this.settings.stylesOpt = -1 !== this.settings.styles.indexOf(a) ? a : this.settings.defaultStyle, "system" === this.settings.stylesOpt ? window.matchMedia("(prefers-color-scheme: dark)").matches ? this.settings.style = "dark" : this.settings.style = "light" : this.settings.style = -1 !== this.settings.styles.indexOf(a) ? a : this.settings.defaultStyle, -1 === this.settings.styles.indexOf(this.settings.style) && (this.settings.style = this.settings.styles[0]), this.settings.contentLayout = "" !== i ? i : this.settings.defaultContentLayout, this.settings.layoutCollapsed = "" !== o ? o : this.settings.defaultMenuCollapsed, this.settings.showDropdownOnHover = "" !== l ? "true" === l : this.settings.defaultShowDropdownOnHover, e = "" !== r && -1 !== ["static", "sticky", "hidden"].indexOf(r) ? r : this.settings.defaultNavbarType, this.settings.layoutNavbarOptions = e, this.settings.layoutFooterFixed = "" !== c ? "true" === c : this.settings.defaultFooterFixed, this.settings.theme = this._getThemeByName(this._getSetting("Theme"), !0), this._hasControls("rtl") || (this.settings.rtl = "rtl" === document.documentElement.getAttribute("dir")), this._hasControls("style") || (this.settings.style = z.contains("dark-style") ? "dark" : "light"), this._hasControls("contentLayout") || (this.settings.contentLayout = null), this._hasControls("headerType") || (this.settings.headerType = null), this._hasControls("layoutCollapsed") || (this.settings.layoutCollapsed = null), this._hasControls("layoutNavbarOptions") || (this.settings.layoutNavbarOptions = null), this._hasControls("themes") || (this.settings.theme = null)
						}
					}, {
						key: "_setup",
						value: function() {
							...
							if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
								...
								if (this._hasControls("headerType")) {
									...
									S.addEventListener("change", x), this._listeners.push([S, "change", x])
								...
								if (this._hasControls("contentLayout")) {
									...
									k.addEventListener("change", C), this._listeners.push([k, "change", C])
								...
								if (this._hasControls("layoutCollapsed")) {
									...
									N = "true" === this.settings.layoutCollapsed ? "collapsed" : "expanded", this.settings.availableLayouts.forEach((function(e) {
						...
						value: function(t, e) {
							...
							if ("number" == typeof document.documentMode && document.documentMode < 11) {
								...
								a.setAttribute("rel", "stylesheet"), a.setAttribute("type", "text/css"), a.className = t, a.setAttribute("href", e), n.parentNode.insertBefore(a, n.nextSibling)
						...
						value: function(t, e) {
							...
							function i(t, e, n) {
								...
								var s, i = "sheet" in a ? "sheet" : "styleSheet",
									o = "sheet" in a ? "cssRules" : "rules",
									l = setTimeout((function() {
										clearInterval(s), clearTimeout(l), e.parentNode.removeChild(a), n(!1, t)
									}), 15e3);
								s = setInterval((function() {
									try {
										a[i] && a[i][o].length && (clearInterval(s), clearTimeout(l), e.parentNode.removeChild(e), n(!0))
									} catch (t) {}
								}), 10), e.parentNode.insertBefore(a, e.nextSibling)
							}
							for (var o = 0; o < n.length; o++) i(n[o], t[n[o]], void((s += 1) >= a && e()))
						}
					}, {
						key: "_loadingState",
						value: function(t, e) {
						...
						value: function(t, e) {
							...
							try {
								localStorage.setItem("templateCustomizer-".concat(n, "--").concat(t), String(e)), this._showResetBtnNotification()
							} catch (t) {}
						}
					}, {
						key: "_getLayoutName",
						...
						value: function(t) {
							...
							return t.split(" ").reduce((function(t, a) {
								return -1 !== e.settings.controls.indexOf(a) ? (n || !1 !== t) && (t = !0) : n && !0 === t || (t = !1), t
							}), null)
						}
					}, {
			...
			A.STYLES = [{
				...
				en: {
					panel_header: "Настройка отображения",
					panel_sub_header: "Настройка и просмотр в реальном времени",
					theming_header: "Темы",
					style_label: "Стиль (Режим)",
					theme_label: "Темы",
					layout_header: "Расположение",
					layout_label: "Меню (навигация)",
					layout_header_label: "Тип заголовков",
					content_label: "Контент",
					layout_navbar_label: "Навигационное меню",
